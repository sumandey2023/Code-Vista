  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          boxShadow: "0 0 60px rgba(0,0,0,0.6), 0 0 40px rgba(34,197,94,0.08)",
        }}
      ...
      >
        ...
        <div className="relative z-10 p-6">
          ...
          <div className="space-y-2 mb-6">
            ...
            <input
              type="password"
              className="w-full px-4 py-3 rounded-xl text-sm font-medium text-green-300 border border-green-500/25 bg-gray-950/70 backdrop-blur-sm focus:outline-none focus:border-green-500/50 transition-colors duration-200"
              style={{ boxShadow: "0 0 12px rgba(34,197,94,0.05)" }}
              placeholder="Set room password (min 4 chars)"
              value={roomConfig.sessionPassword}
              onChange={(e) =>
                setRoomConfig({
                  ...roomConfig,
          ...
          {/* Room summary */}
          {roomConfig.problem && (
            <div className="relative rounded-xl border border-green-500/25 bg-green-950/20 p-4 mb-6 overflow-hidden">
              <div
                className="absolute top-0 left-0 right-0 h-px pointer-events-none"
                style={{
                  background:
